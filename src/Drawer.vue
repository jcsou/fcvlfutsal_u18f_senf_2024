<template>
  ...
  >
    ...
    <v-list dense nav>
      ...
      <v-list-item>
        <v-list-item-subtitle>Futsal U18F/SenF</v-list-item-subtitle>
      </v-list-item>
    </v-list>
  ...
  export default {
    ...
    data: () => ({
      ...
      items: [
        ...
        { title: 'Poules', icon: 'mdi-view-split-vertical', to: '/Cat1Poules.html' },
        { title: 'Finales', icon: 'mdi-format-line-weight', to: '/Cat1Finales.html' },
